...
const PROFILE_TABS: Array<{ description: string; id: ProfileTabId; label: string }> = [
  ...
  },
  {
    id: "security",
    label: "Security",
    description: "Secure wallet export controls.",
  },
];
            ...
            <Card>
              <CardHeader className="pb-5">
                <div className="space-y-2">
                  ...
                  <CardDescription>
                    High-risk actions are isolated inside Coinbase&apos;s secure export flow.
                  </CardDescription>
                </div>
              </CardHeader>
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div className="space-y-2">
                      ...
                      <p className="text-sm text-muted-foreground">
                        Exported private keys grant full control over wallet funds. Only export when
                        you need to migrate the wallet or take direct custody, and never share the
                        key or store it insecurely.
                      </p>
                    </div>
                  </div>
                </div>
